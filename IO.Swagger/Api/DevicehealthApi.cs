...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IDevicehealthApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DevicehealthApi : IDevicehealthApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DevicehealthApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DevicehealthApi(String basePath)
        {
        ...
        /// <returns></returns>
        public DevicehealthApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< DevicehealthStoredDeviceHealthResponseCollection > DevicehealthGetDeviceHealthsWithHttpInfo (int? DeviceChildIdDefunct, string authorization, int? lastDeliveredId = null)
        {
            ...
            {
                Exception exception = ExceptionFactory("DevicehealthGetDeviceHealths", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<DevicehealthStoredDeviceHealthResponseCollection>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (DevicehealthStoredDeviceHealthResponseCollection) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DevicehealthStoredDeviceHealthResponseCollection)));
        }
        ...
        public ApiResponse< DevicehealthStoredDeviceHealthResponseCollection > DevicehealthGetLastDeviceHealthWithHttpInfo (int? DeviceChildIdDefunct, string authorization)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DevicehealthGetLastDeviceHealth", localVarResponse);
                if (exception != null) throw exception;
            }
