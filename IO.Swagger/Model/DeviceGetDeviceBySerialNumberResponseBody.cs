...
{
    /// <summary>
    /// GetDeviceBySerialNumberResponseBody result type (default view)
    /// </summary>
    [DataContract]
    public partial class DeviceGetDeviceBySerialNumberResponseBody :  IEquatable<DeviceGetDeviceBySerialNumberResponseBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGetDeviceBySerialNumberResponseBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DeviceGetDeviceBySerialNumberResponseBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceGetDeviceBySerialNumberResponseBody" /> class.
        /// </summary>
        ...
        public DeviceGetDeviceBySerialNumberResponseBody(string akid = default(string), string displayName = default(string), string firmwareVersion = default(string), string iccid = default(string), string iccid2 = default(string), long? id = default(long?), string meid = default(string), string modelNumber = default(string), string serialNumber = default(string), string siteDisplayName = default(string), int? siteId = default(int?))
        {
            // to ensure "akid" is required (not null)
            if (akid == null)
            {
                throw new InvalidDataException("akid is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
                this.Akid = akid;
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("firmwareVersion is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
            ...
            if (iccid == null)
            {
                throw new InvalidDataException("iccid is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
                this.Iccid = iccid;
            ...
            if (iccid2 == null)
            {
                throw new InvalidDataException("iccid2 is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
                this.Iccid2 = iccid2;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (meid == null)
            {
                throw new InvalidDataException("meid is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
                this.Meid = meid;
            ...
            if (modelNumber == null)
            {
                throw new InvalidDataException("modelNumber is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serialNumber is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("siteDisplayName is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
            ...
            if (siteId == null)
            {
                throw new InvalidDataException("siteId is a required property for DeviceGetDeviceBySerialNumberResponseBody and cannot be null");
            }
            else
            {
                this.SiteId = siteId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeviceGetDeviceBySerialNumberResponseBody {\n");
        ...
        {
            return this.Equals(input as DeviceGetDeviceBySerialNumberResponseBody);
        }

        /// <summary>
        /// Returns true if DeviceGetDeviceBySerialNumberResponseBody instances are equal
        /// </summary>
        /// <param name="input">Instance of DeviceGetDeviceBySerialNumberResponseBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceGetDeviceBySerialNumberResponseBody input)
        {
            if (input == null)
                return false;
