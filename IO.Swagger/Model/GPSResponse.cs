...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GPSResponse :  IEquatable<GPSResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GPSResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GPSResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GPSResponse" /> class.
        /// </summary>
        ...
        public GPSResponse(float? altitude = default(float?), DateTime? date = default(DateTime?), float? dilutionOfPrecision = default(float?), decimal? latitude = default(decimal?), decimal? longitude = default(decimal?), int? numberOfSatellites = default(int?))
        {
            // to ensure "altitude" is required (not null)
            if (altitude == null)
            {
                throw new InvalidDataException("altitude is a required property for GPSResponse and cannot be null");
            }
            else
            {
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for GPSResponse and cannot be null");
            }
            else
            {
                this.Date = date;
            ...
            {
                throw new InvalidDataException("dilutionOfPrecision is a required property for GPSResponse and cannot be null");
            }
            else
            {
            ...
            if (latitude == null)
            {
                throw new InvalidDataException("latitude is a required property for GPSResponse and cannot be null");
            }
            else
            {
            ...
            if (longitude == null)
            {
                throw new InvalidDataException("longitude is a required property for GPSResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("numberOfSatellites is a required property for GPSResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GPSResponse);
        }

        /// <summary>
        /// Returns true if GPSResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GPSResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GPSResponse input)
        {
            if (input == null)
                return false;
