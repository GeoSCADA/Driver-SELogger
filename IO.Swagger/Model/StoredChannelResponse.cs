...
namespace IO.Swagger.Model
{
    ...
    public partial class StoredChannelResponse :  IEquatable<StoredChannelResponse>, IValidatableObject
    {
        ...
        public StoredChannelResponse(DateTime? creationDate = default(DateTime?), int? deviceId = default(int?), string displayName = default(string), string displayStatusName = default(string), long? id = default(long?), long? onDeviceNum = default(long?), int? statusId = default(int?), string typeDisplayName = default(string), int? typeId = default(int?))
        {
            ...
            if (deviceId == null)
            {
                throw new InvalidDataException("deviceId is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            if (onDeviceNum == null)
            {
                throw new InvalidDataException("onDeviceNum is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
