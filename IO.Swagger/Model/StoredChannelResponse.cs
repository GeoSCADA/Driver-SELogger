...
{
    /// <summary>
    /// StoredChannelResponse result type (default view)
    /// </summary>
    [DataContract]
    public partial class StoredChannelResponse :  IEquatable<StoredChannelResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredChannelResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StoredChannelResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredChannelResponse" /> class.
        /// </summary>
        ...
        public StoredChannelResponse(DateTime? creationDate = default(DateTime?), int? DeviceChildIdDefunct = default(int?), string displayName = default(string), string displayStatusName = default(string), long? id = default(long?), long? onDeviceId = default(long?), int? statusId = default(int?), string typeDisplayName = default(string), int? typeId = default(int?))
        {
            // to ensure "creationDate" is required (not null)
            if (creationDate == null)
            {
                throw new InvalidDataException("creationDate is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("DeviceChildIdDefunct is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("displayStatusName is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (onDeviceId == null)
            {
                throw new InvalidDataException("onDeviceId is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            if (statusId == null)
            {
                throw new InvalidDataException("statusId is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("typeDisplayName is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
            ...
            if (typeId == null)
            {
                throw new InvalidDataException("typeId is a required property for StoredChannelResponse and cannot be null");
            }
            else
            {
                this.TypeId = typeId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoredChannelResponse {\n");
        ...
        {
            return this.Equals(input as StoredChannelResponse);
        }

        /// <summary>
        /// Returns true if StoredChannelResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredChannelResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredChannelResponse input)
        {
            if (input == null)
                return false;
