...
{
    /// <summary>
    /// StoredDeviceResponse result type (default view)
    /// </summary>
    [DataContract]
    public partial class StoredDeviceResponse :  IEquatable<StoredDeviceResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredDeviceResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StoredDeviceResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredDeviceResponse" /> class.
        /// </summary>
        ...
        public StoredDeviceResponse(string akid = default(string), string displayName = default(string), string firmwareVersion = default(string), string iccid = default(string), string iccid2 = default(string), long? id = default(long?), string meid = default(string), string modelNumber = default(string), string serialNumber = default(string), string siteDisplayName = default(string), int? siteId = default(int?))
        {
            // to ensure "akid" is required (not null)
            if (akid == null)
            {
                throw new InvalidDataException("akid is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
                this.Akid = akid;
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("firmwareVersion is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
            ...
            if (iccid == null)
            {
                throw new InvalidDataException("iccid is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
                this.Iccid = iccid;
            ...
            if (iccid2 == null)
            {
                throw new InvalidDataException("iccid2 is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
                this.Iccid2 = iccid2;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (meid == null)
            {
                throw new InvalidDataException("meid is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
                this.Meid = meid;
            ...
            if (modelNumber == null)
            {
                throw new InvalidDataException("modelNumber is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serialNumber is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("siteDisplayName is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
            ...
            if (siteId == null)
            {
                throw new InvalidDataException("siteId is a required property for StoredDeviceResponse and cannot be null");
            }
            else
            {
                this.SiteId = siteId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoredDeviceResponse {\n");
        ...
        {
            return this.Equals(input as StoredDeviceResponse);
        }

        /// <summary>
        /// Returns true if StoredDeviceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredDeviceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredDeviceResponse input)
        {
            if (input == null)
                return false;
