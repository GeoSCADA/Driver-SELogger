...
{
    /// <summary>
    /// StoredSampleRFIDResponse result type (default view)
    /// </summary>
    [DataContract]
    public partial class StoredSampleRFIDResponse :  IEquatable<StoredSampleRFIDResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredSampleRFIDResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StoredSampleRFIDResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredSampleRFIDResponse" /> class.
        /// </summary>
        ...
        public StoredSampleRFIDResponse(DateTime? endDate = default(DateTime?), GPSResponse gpsLocationInfo = default(GPSResponse), long? id = default(long?), DateTime? sampleDate = default(DateTime?), DateTime? startDate = default(DateTime?), int? streamId = default(int?), string tagIds = default(string))
        {
            // to ensure "endDate" is required (not null)
            if (endDate == null)
            {
                throw new InvalidDataException("endDate is a required property for StoredSampleRFIDResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("gpsLocationInfo is a required property for StoredSampleRFIDResponse and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for StoredSampleRFIDResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (sampleDate == null)
            {
                throw new InvalidDataException("sampleDate is a required property for StoredSampleRFIDResponse and cannot be null");
            }
            else
            {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for StoredSampleRFIDResponse and cannot be null");
            }
            else
            {
            ...
            if (streamId == null)
            {
                throw new InvalidDataException("streamId is a required property for StoredSampleRFIDResponse and cannot be null");
            }
            else
            {
            ...
            if (tagIds == null)
            {
                throw new InvalidDataException("tagIds is a required property for StoredSampleRFIDResponse and cannot be null");
            }
            else
            {
                this.TagIds = tagIds;
        ...
        public GPSResponse GpsLocationInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoredSampleRFIDResponse {\n");
        ...
        {
            return this.Equals(input as StoredSampleRFIDResponse);
        }

        /// <summary>
        /// Returns true if StoredSampleRFIDResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredSampleRFIDResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredSampleRFIDResponse input)
        {
            if (input == null)
                return false;
