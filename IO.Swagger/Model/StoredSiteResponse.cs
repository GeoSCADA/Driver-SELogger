...
namespace IO.Swagger.Model
{
    ...
    public partial class StoredSiteResponse :  IEquatable<StoredSiteResponse>, IValidatableObject
    {
        ...
        public StoredSiteResponse(int? accountOrganizationId = default(int?), DateTime? creationDate = default(DateTime?), string displayName = default(string), long? id = default(long?), string latitude = default(string), string longitude = default(string), string status = default(string))
        {
            ...
            if (latitude == null)
            {
                throw new InvalidDataException("latitude is a required property for StoredSiteResponse and cannot be null");
            }
            else
            {
            ...
            if (longitude == null)
            {
                throw new InvalidDataException("longitude is a required property for StoredSiteResponse and cannot be null");
            }
            else
            {
