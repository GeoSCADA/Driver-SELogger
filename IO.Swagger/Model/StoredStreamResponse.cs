...
{
    /// <summary>
    /// StoredStreamResponse result type (default view)
    /// </summary>
    [DataContract]
    public partial class StoredStreamResponse :  IEquatable<StoredStreamResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredStreamResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StoredStreamResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StoredStreamResponse" /> class.
        /// </summary>
        ...
        public StoredStreamResponse(DateTime? creationDate = default(DateTime?), string displayName = default(string), long? id = default(long?), int? siteId = default(int?), int? statusId = default(int?), string typeDisplayName = default(string), int? typeId = default(int?), string units = default(string), string valueScale = default(string))
        {
            // to ensure "creationDate" is required (not null)
            if (creationDate == null)
            {
                throw new InvalidDataException("creationDate is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (siteId == null)
            {
                throw new InvalidDataException("siteId is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
                this.SiteId = siteId;
            ...
            if (statusId == null)
            {
                throw new InvalidDataException("statusId is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("typeDisplayName is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
            ...
            if (typeId == null)
            {
                throw new InvalidDataException("typeId is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
                this.TypeId = typeId;
            ...
            if (units == null)
            {
                throw new InvalidDataException("units is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
                this.Units = units;
            ...
            if (valueScale == null)
            {
                throw new InvalidDataException("valueScale is a required property for StoredStreamResponse and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StoredStreamResponse {\n");
        ...
        {
            return this.Equals(input as StoredStreamResponse);
        }

        /// <summary>
        /// Returns true if StoredStreamResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of StoredStreamResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoredStreamResponse input)
        {
            if (input == null)
                return false;
