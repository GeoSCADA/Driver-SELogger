...
{
    /// <summary>
    /// ThresholdActionNotificationRequestBody
    /// </summary>
    [DataContract]
    public partial class ThresholdActionNotificationRequestBody :  IEquatable<ThresholdActionNotificationRequestBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThresholdActionNotificationRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThresholdActionNotificationRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThresholdActionNotificationRequestBody" /> class.
        /// </summary>
        ...
        public ThresholdActionNotificationRequestBody(int? numRepeatsAllOnFailed = default(int?), long? relevanceThreshold = default(long?), int? repeatsPerUserOnFailed = default(int?), TypeEnum type = default(TypeEnum), int? userGroupId = default(int?))
        {
            // to ensure "numRepeatsAllOnFailed" is required (not null)
            if (numRepeatsAllOnFailed == null)
            {
                throw new InvalidDataException("numRepeatsAllOnFailed is a required property for ThresholdActionNotificationRequestBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("relevanceThreshold is a required property for ThresholdActionNotificationRequestBody and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("repeatsPerUserOnFailed is a required property for ThresholdActionNotificationRequestBody and cannot be null");
            }
            else
            {
...
#pragma warning restore CS0472 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ...
            if (userGroupId == null)
            {
                throw new InvalidDataException("userGroupId is a required property for ThresholdActionNotificationRequestBody and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThresholdActionNotificationRequestBody {\n");
        ...
        {
            return this.Equals(input as ThresholdActionNotificationRequestBody);
        }

        /// <summary>
        /// Returns true if ThresholdActionNotificationRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ThresholdActionNotificationRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThresholdActionNotificationRequestBody input)
        {
            if (input == null)
                return false;
