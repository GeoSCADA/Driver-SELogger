...
{
    /// <summary>
    /// ThresholdActionOutputResponseBody
    /// </summary>
    [DataContract]
    public partial class ThresholdActionOutputResponseBody :  IEquatable<ThresholdActionOutputResponseBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThresholdActionOutputResponseBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThresholdActionOutputResponseBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThresholdActionOutputResponseBody" /> class.
        /// </summary>
        ...
        public ThresholdActionOutputResponseBody(int? channelNum = default(int?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "channelNum" is required (not null)
            if (channelNum == null)
            {
                throw new InvalidDataException("channelNum is a required property for ThresholdActionOutputResponseBody and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ThresholdActionOutputResponseBody and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThresholdActionOutputResponseBody {\n");
        ...
        {
            return this.Equals(input as ThresholdActionOutputResponseBody);
        }

        /// <summary>
        /// Returns true if ThresholdActionOutputResponseBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ThresholdActionOutputResponseBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThresholdActionOutputResponseBody input)
        {
            if (input == null)
                return false;
