...
{
    /// <summary>
    /// ThresholdActionSampleRequestBody
    /// </summary>
    [DataContract]
    public partial class ThresholdActionSampleRequestBody :  IEquatable<ThresholdActionSampleRequestBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ThresholdActionSampleRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ThresholdActionSampleRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ThresholdActionSampleRequestBody" /> class.
        /// </summary>
        ...
        public ThresholdActionSampleRequestBody(int? sampleGroupId = default(int?), int? streamId = default(int?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "streamId" is required (not null)
            if (streamId == null)
            {
                throw new InvalidDataException("streamId is a required property for ThresholdActionSampleRequestBody and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ThresholdActionSampleRequestBody and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ThresholdActionSampleRequestBody {\n");
        ...
        {
            return this.Equals(input as ThresholdActionSampleRequestBody);
        }

        /// <summary>
        /// Returns true if ThresholdActionSampleRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ThresholdActionSampleRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ThresholdActionSampleRequestBody input)
        {
            if (input == null)
                return false;
